    ...
    <main className="bg-black min-h-screen">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-primary mb-6">Terms of Service</h1>
            ...
            {mounted && !loading ? (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: settings.terms_of_service_content?.replace(/\n/g, "<br />") || 
                    "Terms of service content will appear here once updated by the administrator.",
                }}
              />
            ) : (
