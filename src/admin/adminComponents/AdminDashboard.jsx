...
//                 <p className={style.black}>Systems of Government</p>
//                 <p className={style.grey}>
//                   Capitalism System of Government . 15 exercises.
//                 </p>
//               </div>
//             </div>
//             <div className={style.videos}>
//               <button className={style.watch}>Watch Video</button>
//             </div>
//           </div>
...
//               <p className={style.black}>Economics</p>
//             </div>
...
//             </select>
//           </div>
//           <img src="/images/progressStat.png" alt="progress" className={style.progressStat} />
